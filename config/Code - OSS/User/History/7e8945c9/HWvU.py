...
def count_problems_by_difficulty(start_date, end_date):
    ...
    # Debugging: print submissions data
    print("Submissions Data:", json.dumps(submissions_data, indent=2))
    ...
    if 'data' in submissions_data and 'recentAcSubmissionList' in submissions_data['data']:
        ...
        # Debugging: print problems data
        print("Problems Data:", json.dumps(problems_data, indent=2))
        ...
        # Debugging: print problems dictionary
        print("Problems Dictionary:", json.dumps(problems, indent=2))
